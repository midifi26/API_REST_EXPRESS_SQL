...
ALTER TABLE entries ADD CONSTRAINT title_unique UNIQUE (title);
...
--Borrar datos de la tabla entries por título.
DELETE FROM entries WHERE title ='Noticia: SOL en Madrid';
